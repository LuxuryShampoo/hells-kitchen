...
dependencies {
    implementation(platform("org.http4k:http4k-bom:6.13.0.0"))
...
tasks {
    ...
    val runServer by registering {
        ...
        doLast {
            ...
            val process =
                ProcessBuilder("java", "-cp", sourceSets["main"].runtimeClasspath.asPath, "xyz.malefic.hell.MainKt")
...
application {
    mainClass.set("xyz.malefic.hell.MainKt")
}
